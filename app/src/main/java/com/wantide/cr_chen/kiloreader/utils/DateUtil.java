...
public class DateUtil {
    ...
    /**
     * 精确到毫秒的完整时间    如：yyyy-MM-dd HH:mm:ss
     */
     ...
     * @return
     */
    public static String getPreDataStr(int mPreTime){
        Date as = new Date(new Date().getTime() - Constants.ONE_DAY_TIME * mPreTime);
     ...
     */
    //
    public static String getBaiDeJieTime(long time) {

        return new SimpleDateFormat(FORMAT_FULL_SN).format(time);
